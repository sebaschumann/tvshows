...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { begins_at: @season.begins_at, novela_id: @season.novela_id, number: @season.number } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { begins_at: @season.begins_at, novela_id: @season.novela_id, number: @season.number } }
